    ...
    <div>
      <header className="header">
        ...
        <nav className="navbar">
          <ul>
            ...
            <li>
              {" "}
              <Link to="/products" onClick={() =>  showDropdown(produtsShow, setProductsShow)}>
              Special Alloys
                <i
                  style={{ marginLeft: "10px" }}
                  class="fa-solid fa-chevron-down"
          ...
          <nav className="navbar_mobile active ">
            <ul className="mt-4">
              ...
              <li>
                ...
                <ul className={mobileprodutsShow ? "" : "d-none"} style={{background:"#082152"}}>
                  <li
                    className="Manufacturing_c"
                    setManufShowP
                   
                  >
                    <Link to=""  onClick={() => showDropdown(manufShowP, setManufShowP)}>
                      Manufacturing{" "}
                      <i
                        class={
                          manufShowP ? "fa-solid fa-minus mx-2" : "fa-solid fa-plus mx-2"
                        }
                      ></i>
                    </Link>
                    <ul className={manufShowP ? "" : "d-none"} style={{}}>
                      {ProductData.map((item) => {
                        if (item.id >= 7) {
                          return (
                            <li >
                              <Link to={item.link} onClick={()=>setproductnav(item.heading)}>
                                {" "}
                                {item.heading}{" "}
                                {item.heading == "Pipe Fittings" ||
                                item.heading == "Flanges" ? (
                                  <i
                                    class={
                                      item.heading == "Pipe Fittings"?pipeShowP? "fa-solid fa-minus mx-2"
                                      : "fa-solid fa-plus mx-2":
                                      flangeShowP
                                        ? "fa-solid fa-minus mx-2"
                                        : "fa-solid fa-plus mx-2"
                  ...
                  >
                    ...
                    <ul className={tradingShowP ? "" : "d-none"} style={{background:"#06183b"}}>
                      {ProductData.map((item) => {
                        if (item.id <= 6) {
                          return (
                            <li>
      ...
      {contactInfoShow ? (
        <div className="contact-info active">
          ...
          <div className="info">
            <a href="tel:+91 9875782537" style={{ textDecoration: "none" }}>
              {" "}
